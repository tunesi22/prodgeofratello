...
export const post: Post = {
  ...
  "excerpt": "SEO belum mati, tapi GEO tumbuh jauh lebih cepat. Inilah perbandingan jujur keduanya dan bagaimana brand Indonesia harus membagi prioritas di tahun 2026.",
  "sections": [
    {
