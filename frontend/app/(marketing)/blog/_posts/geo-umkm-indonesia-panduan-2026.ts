...
export const post: Post = {
  ...
  "excerpt": "GEO bukan hanya untuk brand besar. UMKM dengan strategi yang tepat justru bisa membangun keunggulan AI yang sulit dikejar brand enterprise. Inilah caranya.",
  "sections": [
    {
