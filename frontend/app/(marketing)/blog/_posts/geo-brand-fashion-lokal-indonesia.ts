...
export const post: Post = {
  ...
  "excerpt": "Industri fashion lokal Indonesia sedang booming — tapi di mesin AI, hanya segelintir brand yang dikenal. Ini peluang besar yang belum banyak dimanfaatkan.",
  "sections": [
    {
