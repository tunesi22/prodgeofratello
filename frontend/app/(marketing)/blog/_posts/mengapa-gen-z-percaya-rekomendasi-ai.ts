...
export const post: Post = {
  ...
  "excerpt": "Survei terbaru terhadap 3.000 konsumen muda Indonesia mengungkap pergeseran kepercayaan yang dramatis dari iklan ke rekomendasi AI. Ini implikasinya untuk brand.",
  "sections": [
    {
