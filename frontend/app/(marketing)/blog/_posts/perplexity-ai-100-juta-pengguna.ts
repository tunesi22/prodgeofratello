...
export const post: Post = {
  ...
  "excerpt": "Platform AI search Perplexity mengumumkan pencapaian 100 juta pengguna aktif bulanan per Juni 2026. Ini bukan sekadar angka — ini sinyal pergeseran besar perilaku konsumen.",
  "sections": [
    {
