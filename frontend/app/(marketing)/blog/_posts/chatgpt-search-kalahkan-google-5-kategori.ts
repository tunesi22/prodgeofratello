...
export const post: Post = {
  ...
  "excerpt": "Riset terbaru Juni 2026 mengungkap ChatGPT Search mulai mengambil pangsa pasar Google di kategori rekomendasi produk, perjalanan, keuangan, kesehatan, dan teknologi.",
  "sections": [
    {
