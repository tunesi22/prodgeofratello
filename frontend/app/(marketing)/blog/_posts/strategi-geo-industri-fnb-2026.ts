...
export const post: Post = {
  ...
  "excerpt": "Industri makanan dan minuman adalah salah satu yang paling aktif ditanyakan ke mesin AI. Ini panduan GEO spesifik untuk brand F&B yang ingin mendominasi rekomendasi AI.",
  "sections": [
    {
