...
export const post: Post = {
  ...
  "excerpt": "Setiap mesin AI memiliki karakteristik berbeda dalam memilih brand yang disebut. Inilah temuan dari analisis 10.000 prompt terhadap Claude dan ChatGPT untuk brand Indonesia.",
  "sections": [
    {
