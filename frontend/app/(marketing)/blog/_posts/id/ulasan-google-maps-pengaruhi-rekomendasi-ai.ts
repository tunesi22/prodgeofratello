...
export const post: Post = {
  ...
  "excerpt": "Ulasan Google Maps bukan hanya untuk menarik pelanggan baru — data ulasan digunakan langsung oleh Gemini dan AI lain untuk menentukan brand mana yang layak direkomendasikan.",
  "sections": [
    {
