...
export const post: Post = {
  ...
  "excerpt": "GEO adalah praktik mengoptimalkan konten brand agar direkomendasikan oleh mesin AI seperti ChatGPT, Gemini, dan Perplexity — bukan hanya muncul di hasil pencarian Google.",
  "sections": [
    {
