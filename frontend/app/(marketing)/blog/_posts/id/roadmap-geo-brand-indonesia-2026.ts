...
export const post: Post = {
  ...
  "excerpt": "Landscape AI search berubah cepat. Inilah roadmap 6 bulan yang bisa langsung dieksekusi brand Indonesia untuk membangun dominasi di mesin AI sebelum kompetitor.",
  "sections": [
    {
