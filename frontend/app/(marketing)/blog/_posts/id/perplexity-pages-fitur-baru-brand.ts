...
export const post: Post = {
  ...
  "excerpt": "Perplexity meluncurkan Pages — format konten baru yang memungkinkan brand dan kreator mempublikasikan konten yang secara langsung diindeks dan dikutip oleh Perplexity AI.",
  "sections": [
    {
