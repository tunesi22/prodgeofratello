...
export const post: Post = {
  ...
  "excerpt": "Visibilitas AI tidak bisa diukur dengan metrik SEO biasa. Fratello memperkenalkan GEO Score — framework pengukuran komprehensif untuk era AI search.",
  "sections": [
    {
