...
export const post: Post = {
  ...
  "excerpt": "Banyak brand Indonesia sudah mulai sadar pentingnya GEO, tapi melakukan kesalahan yang justru menghambat visibilitas mereka di mesin AI. Apakah Anda melakukan salah satunya?",
  "sections": [
    {
