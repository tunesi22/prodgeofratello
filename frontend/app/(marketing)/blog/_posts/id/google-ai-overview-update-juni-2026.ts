...
export const post: Post = {
  ...
  "excerpt": "Google merilis pembaruan signifikan pada fitur AI Overview di akhir Juni 2026. Tampilan baru, cakupan lebih luas, dan cara baru AI memilih brand untuk disebut.",
  "sections": [
    {
