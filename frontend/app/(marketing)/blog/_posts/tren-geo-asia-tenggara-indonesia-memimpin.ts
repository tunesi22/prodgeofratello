...
export const post: Post = {
  ...
  "excerpt": "Laporan terbaru menunjukkan Indonesia adalah pasar dengan adopsi AI search tertinggi di Asia Tenggara, tapi juga dengan kesenjangan GEO terbesar. Inilah peluangnya.",
  "sections": [
    {
