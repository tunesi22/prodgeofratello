...
export async function triggerScan(brandId: string): Promise<{ jobsEnqueued: number; scanId: string }> {
  ...
  const totalJobs = prompts.length * LLM_MODELS.length * repeatCount
